...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm leading-[100%] font-semibold cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-gray-300",
  {
    variants: {
      variant: {
        default:
        ...
        primary: "bg-orange-500 text-white shadow-sm hover:bg-orange-500/90 dark:bg-orange-500 dark:text-white dark:hover:bg-orange-500/90",
      },
      size: {
